    ...
    def do_GET(self) -> None:
        ...
        if path == "/api/admin/overview":
            ...
            for row in user_rows:
                ...
                item["loginLocked"] = bool(lock_info["locked"])
                item["loginFailedCount"] = int(lock_info["failedCount"])
...
def serve() -> None:
    ...
    print("SUPERSONIC Enterprise API Core v3.2")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="SUPERSONIC Enterprise API Core v3.2")
