...
ENTERPRISE_HTML_PATH = BASE_DIR / "supersonic_enterprise_v1.html"
...
def serve() -> None:
    ...
    print("SUPERSONIC Enterprise API Core v1")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="SUPERSONIC Enterprise API Core v1")
