...
ENTERPRISE_HTML_PATH = BASE_DIR / "supersonic_enterprise_dashboard_v2_2_권역URL차단.html"
...
class ApiHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        if path == "/api/health":
            self._json(HTTPStatus.OK, {"ok": True, "service": "SUPERSONIC Enterprise API", "version": "v1"})
            return
...
def serve() -> None:
    ...
    print("SUPERSONIC Enterprise API Core v2.2")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="SUPERSONIC Enterprise API Core v2.2")
