...
ADMIN_HTML_PATH = BASE_DIR / "supersonic_enterprise_admin_v3_1_비밀번호정책.html"
...
def serve() -> None:
    ...
    print("SUPERSONIC Enterprise API Core v3.1")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="SUPERSONIC Enterprise API Core v3.1")
