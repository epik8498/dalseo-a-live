...
ENTERPRISE_HTML_PATH = BASE_DIR / "supersonic_enterprise_dashboard_v2_4_HQ권한.html"
ADMIN_HTML_PATH = BASE_DIR / "supersonic_enterprise_admin_v2_1_지사계정정보.html"
...
class ApiHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        if path == "/api/health":
            self._json(HTTPStatus.OK, {"ok": True, "service": "SUPERSONIC Enterprise API", "version": "v2.4.2"})
            return
...
def serve() -> None:
    ...
    print("SUPERSONIC Enterprise API Core v2.4.2")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="SUPERSONIC Enterprise API Core v2.4.2")
