...
ENTERPRISE_HTML_PATH = BASE_DIR / "supersonic_enterprise_dashboard_v2_5_Collector상태관제.html"
...
class ApiHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        if path == "/api/health":
            self._json(HTTPStatus.OK, {"ok": True, "service": "SUPERSONIC Enterprise API", "version": "v2.5"})
            return
...
def serve() -> None:
    ...
    print("SUPERSONIC Enterprise API Core v2.5")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="SUPERSONIC Enterprise API Core v2.5")
