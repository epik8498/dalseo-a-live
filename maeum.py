...
def main():
    print("MAEUM 독립 다권역 DOM 자동 수집기")
    print("대상 권역:", ", ".join(c["area"] for c in CENTER_CONFIGS))
    with sync_playwright() as p:
        browser = p.chromium.launch_persistent_context(user_data_dir=str(BASE_DIR / "chrome_profile_maeum_isolated"), headless=False, viewport={"width": 1400, "height": 900}, args=["--disable-gpu", "--disable-dev-shm-usage", "--disable-extensions", "--mute-audio"])
